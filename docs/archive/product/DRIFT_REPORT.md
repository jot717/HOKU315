...
| `docs/active/uat/README.md` | `compatibility meter shown` | UAT checklist reinforces meter-as-product centerpiece. |
...
| `docs/archive/root_legacy/SPRINT_PLAN.md` | `穩定核心配對流程` | Planning language elevates 配對 as core vs. signal system. |
