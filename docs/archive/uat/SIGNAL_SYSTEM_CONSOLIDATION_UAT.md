...
**PAIRING:** [`docs/active/product/SIGNAL_SYSTEM_CONSTITUTION.md`](../product/SIGNAL_SYSTEM_CONSTITUTION.md), [`docs/active/product/SIGNAL_FLOW_ARCHITECTURE.md`](../product/SIGNAL_FLOW_ARCHITECTURE.md)
...
| U5 | Constitution + schema + flow + audit + state mapping docs exist in `docs/active/product/` | CI doc regression test |
