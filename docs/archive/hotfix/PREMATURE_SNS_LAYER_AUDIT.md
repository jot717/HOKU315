...
### Product docs (`docs/active/product/*`, `BACKLOG.md`)

- **Reason:** Roadmap mentions SNS / social graph as **future** north star.
- **Behavior:** Strategic docs, not runtime UI.
- **Change:** **Phase-later** language remains; **no** requirement to delete roadmap. **Rule:** Do not surface this language inside Phase1 pages (see `docs/active/product/PHASE_BOUNDARY_SYSTEM.md`).
