...
* **PHASE1-G PROJECT GOVERNANCE & PRODUCT CLARITY v1**: `ops/product/PRODUCT_MASTER.md`, `REPO_GOVERNANCE_RULES.md`, `backlog/MASTER_BACKLOG.md`, `ops/uat/UAT_MASTER_GUIDE.md`; README indexes; `docs/deprecated/archive/` + `backlog/archive/`; home guest/account CTAs; login/nav clarity.
...
REFERENCES: [`ops/product/RELATIONSHIP_INTELLIGENCE_CONSTITUTION.md`](ops/product/RELATIONSHIP_INTELLIGENCE_CONSTITUTION.md), [`backlog/BACKLOG_RELATIONSHIP_SIGNAL_SIMULATION_v1.md`](backlog/BACKLOG_RELATIONSHIP_SIGNAL_SIMULATION_v1.md), [`backlog/SPRINT_RELATIONSHIP_SIGNAL_SIMULATION_v1.md`](backlog/SPRINT_RELATIONSHIP_SIGNAL_SIMULATION_v1.md)
