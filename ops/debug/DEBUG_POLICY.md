...
本檔約束 **P0 HOTFIX** 與 **AI-assisted patch** 的允許範圍，與 [**`ops/debug/DEBUG_GUIDE.md`**](ops/debug/DEBUG_GUIDE.md)、[**`debug_evidence/README.md`**](debug_evidence/README.md) 並行使用：**先有證據**，再最小修正。

---

## P0 HOTFIX — **禁止**

在未封存 **`debug_evidence/YYYY-MM-DD-…`** 證據且未完成 **`ops/debug/DEBUG_GUIDE.md`** 所述分层判定前，**禁止**：
