...
* User can state why profile exists and what happens after save
* User can state what observation does before running it
* After a result, user sees why + what to do next (no “now what?”)
