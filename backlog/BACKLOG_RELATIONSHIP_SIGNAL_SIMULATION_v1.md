# BACKLOG — RELATIONSHIP SIGNAL SIMULATION v1
...
RELATIONSHIP INTELLIGENCE FOUNDATION (synthetic archetypes + overlap simulation; **SAFE MODE**)

## GOAL

Begin **interaction intelligence**: simulate **relationship-shaped** risk with archetypes, overlap user `infer_signal_risks` scores, surface guardian copy focused on **interaction danger**, and tag fox memory with recurring pattern exposure — **without** SNS APIs, multi-user systems, embeddings, or backend rewrites.
...
Real SNS ingestion, auth, Supabase changes, vector DB, multi-user graph storage.

## SPRINT

[`SPRINT_RELATIONSHIP_SIGNAL_SIMULATION_v1.md`](SPRINT_RELATIONSHIP_SIGNAL_SIMULATION_v1.md)
